...
function Navbar() {
  ...
  return (
    <div className="absolute w-full p-4 flex items-center justify-between z-50 ">
      <Link to="/">
        <h1 className="text text-red-600  font-nsans-bold cursor-pointer text-5xl">
          NETFLIX
        </h1>
      </Link>
      ...
      {user?.email ? (
        <div>
          <Link to="/profile">
            <button className="capiitalize pr-4">profile</button>
          </Link>
        ...
        <div>
          <Link to="/login">
            <button className="capiitalize pr-4">login</button>
          </Link>
          <Link to="/signup">
